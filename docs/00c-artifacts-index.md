...
The repo is public at `https://github.com/darLAAGAM/ai-native-playbook`. It is published as open educational infrastructure: free to use, attribution requested. That means you can copy the templates, adapt the prompts, rewrite the skills, and use the schemas inside your own company. If you publish derivative work, attribution is requested. There is no warranty.
...
1. Open the repo: `https://github.com/darLAAGAM/ai-native-playbook`.
